...
public class ManagerGetsManagerPolicy extends AbstractPolicy<UserPermissionPolicyContext> {

    @Override
    public boolean isSatisfiedWith(@NonNull UserPermissionPolicyContext context) {
        return context.principal().isManager() && context.processed().isManager();
    }
}
