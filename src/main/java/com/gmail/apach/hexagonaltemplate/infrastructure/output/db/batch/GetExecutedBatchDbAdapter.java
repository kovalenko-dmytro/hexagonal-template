...
public class GetExecutedBatchDbAdapter implements GetExecutedBatchOutputPort {
    ...
    public ExecutedBatch get(String batchId) {
        final var batchView = batchRepository.get(batchId)
    ...
    private String buildGetBatchErrorMessage(String batchId) {
        return messageSource.getMessage(
            ...
            new Object[]{
                AttributeForModel.BATCH.getName(),
                AttributeForModel.Field.ID.getFieldName(), batchId},
