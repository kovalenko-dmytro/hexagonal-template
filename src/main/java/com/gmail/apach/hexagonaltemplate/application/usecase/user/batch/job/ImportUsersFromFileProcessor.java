package com.gmail.apach.hexagonaltemplate.application.usecase.user.batch.job;

import com.gmail.apach.hexagonaltemplate.application.usecase.user.batch.job.processor.ImportUsersFromFileProcessorStrategyProvider;
...
public class ImportUsersFromFileProcessor implements Tasklet, StepExecutionListener {
    ...
    private final ImportUsersFromFileProcessorStrategyProvider provider;
