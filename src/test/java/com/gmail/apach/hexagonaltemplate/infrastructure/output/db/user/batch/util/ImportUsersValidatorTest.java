...
class ImportUsersValidatorTest {
    ...
    void validateExcelFile_success() throws IOException {
        ...
        assertDoesNotThrow(() -> ImportUsersValidator.validateExcelFile(excelBook));
    }
    ...
    void validateExcelFile_sheetNotExist_fail() {
        ...
        assertThrows(
            ...
            () -> ImportUsersValidator.validateExcelFile(excelBook),
    ...
    void validateModels_success() {
        ...
        assertDoesNotThrow(() -> ImportUsersValidator.validateModels(users));
    }
