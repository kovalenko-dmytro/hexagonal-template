...
class GetExecutedBatchRESTAdapterTest extends AbstractControllerIntegrationTest {
    ...
    void getBatch_success() throws Exception {
        ...
        final var batchResponse = objectMapper.readValue(content, GetExecutedBatchResponse.class);
