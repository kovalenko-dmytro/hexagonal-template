...
class ImportUsersFromFileRESTAdapterTest extends AbstractControllerIntegrationTest {
    ...
    void importUsers_success() throws Exception {
        ...
        final var jsonRequest = objectMapper.writeValueAsString(
            ImportUsersFromFileRequest.builder().fileId(uploadedResponse.fileId()).build());
    ...
    void importUsers_badRequest() throws Exception {
        final var jsonRequest = objectMapper.writeValueAsString(
            ImportUsersFromFileRequest.builder().fileId(StringUtils.EMPTY).build());
    ...
    void importUsers_forbidden() throws Exception {
        final var jsonRequest = objectMapper.writeValueAsString(
            ImportUsersFromFileRequest.builder().fileId("some-file-id").build());
