...
import com.gmail.apach.hexagonaltemplate.application.usecase.user.batch.job.processor.impl.ImportUsersFromExcelProcessorStrategy;
...
class ImportUsersFromExcelProcessorStrategyTest {
    ...
    void process_success() throws IOException {
        ...
        final var actual = importUsersFromExcelProcessorStrategy.process(storedFile);
