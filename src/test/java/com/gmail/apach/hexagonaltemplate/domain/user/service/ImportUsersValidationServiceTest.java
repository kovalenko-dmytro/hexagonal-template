...
class ImportUsersValidationServiceTest {
    ...
    void validateExcelFile_success() throws IOException {
        ...
        assertDoesNotThrow(() -> ImportUsersValidationService.validateExcelFile(excelBook));
    }
    ...
    void validateExcelFile_sheetNotExist_fail() {
        ...
        assertThrows(
            ...
            () -> ImportUsersValidationService.validateExcelFile(excelBook),
    ...
    void validateModels_success() {
        ...
        assertDoesNotThrow(() -> ImportUsersValidationService.validateModels(users));
    }
